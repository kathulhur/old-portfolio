...
import './projects.css'
import { Title, Project } from '../../components/index'
...
const projectsData = [
    ...
    {
        title: "Inventory Management System",
        description: "An inventory management system that has functionality such as creating, reading, updating, and deleting data records.\
